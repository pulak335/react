    ...
    <>
      <Routes>
        ...
        <Route
          path="/"
          element={
            <ProtectedRoutes roles="wholeseller retailer admin deliveryman salesman manager" />
          }
        >
        ...
        <Route
          path="/"
          element={<ProtectedRoutes roles="wholeseller retailer admin" />}
        >
        ...
        <Route path="/" element={<ProtectedRoutes roles="wholeseller admin" />}>
        ...
        <Route
          path="/"
          element={<ProtectedRoutes roles="wholeseller retailer" />}
        >
        ...
        <Route
          path="/"
          element={<ProtectedRoutes roles="retailer admin" />}
        ></Route>

        {/* Only Wholesaler */}
        <Route path="/" element={<ProtectedRoutes roles="wholeseller" />}>
          <Route
        ...
        {/* Only Retailer */}
        <Route path="/" element={<ProtectedRoutes roles="retailer" />}>
        ...
        {/* Only Admin */}
        <Route path="/" element={<ProtectedRoutes roles="admin" />}>
